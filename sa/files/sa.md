...
When new kms feature available, you have to manually add them to existing key policy, if you want to use them (until you do these, if you just add these features from iam, it won't work)
